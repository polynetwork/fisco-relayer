...
func AsyncDeployONGX(auth *bind.TransactOpts, handler func(*types.Receipt, error), backend bind.ContractBackend, proxyContractAddress common.Address) (*types.Transaction, error) {
	parsed, err := abi.JSON(strings.NewReader(ONGXABI))
	if err != nil {
		return nil, err
	}

	tx, err := bind.AsyncDeployContract(auth, handler, parsed, common.FromHex(ONGXBin), backend, proxyContractAddress)
	if err != nil {
		return nil, err
	}
	return tx, nil
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ONGX *ONGXRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.ONGXTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ONGX *ONGXRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, *types.Receipt, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ONGX *ONGXTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ONGX *ONGXTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, *types.Receipt, error) {
...
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactor) Approve(opts *bind.TransactOpts, spender common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.contract.Transact(opts, "approve", spender, amount)
}

func (_ONGX *ONGXTransactor) AsyncApprove(handler func(*types.Receipt, error), opts *bind.TransactOpts, spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.contract.AsyncTransact(opts, handler, "approve", spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x1f2d4860.
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ONGX *ONGXSession) Approve(spender common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.Approve(&_ONGX.TransactOpts, spender, amount)
}

func (_ONGX *ONGXSession) AsyncApprove(handler func(*types.Receipt, error), spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncApprove(handler, &_ONGX.TransactOpts, spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x1f2d4860.
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactorSession) Approve(spender common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.Approve(&_ONGX.TransactOpts, spender, amount)
}

func (_ONGX *ONGXTransactorSession) AsyncApprove(handler func(*types.Receipt, error), spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncApprove(handler, &_ONGX.TransactOpts, spender, amount)
}
...
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ONGX *ONGXTransactor) DecreaseAllowance(opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.contract.Transact(opts, "decreaseAllowance", spender, subtractedValue)
}

func (_ONGX *ONGXTransactor) AsyncDecreaseAllowance(handler func(*types.Receipt, error), opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.contract.AsyncTransact(opts, handler, "decreaseAllowance", spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0x13a1aa5c.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ONGX *ONGXSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.DecreaseAllowance(&_ONGX.TransactOpts, spender, subtractedValue)
}

func (_ONGX *ONGXSession) AsyncDecreaseAllowance(handler func(*types.Receipt, error), spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncDecreaseAllowance(handler, &_ONGX.TransactOpts, spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0x13a1aa5c.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ONGX *ONGXTransactorSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.DecreaseAllowance(&_ONGX.TransactOpts, spender, subtractedValue)
}

func (_ONGX *ONGXTransactorSession) AsyncDecreaseAllowance(handler func(*types.Receipt, error), spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncDecreaseAllowance(handler, &_ONGX.TransactOpts, spender, subtractedValue)
}
...
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ONGX *ONGXTransactor) IncreaseAllowance(opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.contract.Transact(opts, "increaseAllowance", spender, addedValue)
}

func (_ONGX *ONGXTransactor) AsyncIncreaseAllowance(handler func(*types.Receipt, error), opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.contract.AsyncTransact(opts, handler, "increaseAllowance", spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x4d2e8120.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ONGX *ONGXSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.IncreaseAllowance(&_ONGX.TransactOpts, spender, addedValue)
}

func (_ONGX *ONGXSession) AsyncIncreaseAllowance(handler func(*types.Receipt, error), spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncIncreaseAllowance(handler, &_ONGX.TransactOpts, spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x4d2e8120.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ONGX *ONGXTransactorSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.IncreaseAllowance(&_ONGX.TransactOpts, spender, addedValue)
}

func (_ONGX *ONGXTransactorSession) AsyncIncreaseAllowance(handler func(*types.Receipt, error), spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncIncreaseAllowance(handler, &_ONGX.TransactOpts, spender, addedValue)
}
...
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactor) Transfer(opts *bind.TransactOpts, recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.contract.Transact(opts, "transfer", recipient, amount)
}

func (_ONGX *ONGXTransactor) AsyncTransfer(handler func(*types.Receipt, error), opts *bind.TransactOpts, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.contract.AsyncTransact(opts, handler, "transfer", recipient, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0x6904e965.
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXSession) Transfer(recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.Transfer(&_ONGX.TransactOpts, recipient, amount)
}

func (_ONGX *ONGXSession) AsyncTransfer(handler func(*types.Receipt, error), recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncTransfer(handler, &_ONGX.TransactOpts, recipient, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0x6904e965.
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactorSession) Transfer(recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.Transfer(&_ONGX.TransactOpts, recipient, amount)
}

func (_ONGX *ONGXTransactorSession) AsyncTransfer(handler func(*types.Receipt, error), recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncTransfer(handler, &_ONGX.TransactOpts, recipient, amount)
}
...
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactor) TransferFrom(opts *bind.TransactOpts, sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.contract.Transact(opts, "transferFrom", sender, recipient, amount)
}

func (_ONGX *ONGXTransactor) AsyncTransferFrom(handler func(*types.Receipt, error), opts *bind.TransactOpts, sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.contract.AsyncTransact(opts, handler, "transferFrom", sender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0xad8a9731.
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXSession) TransferFrom(sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.TransferFrom(&_ONGX.TransactOpts, sender, recipient, amount)
}

func (_ONGX *ONGXSession) AsyncTransferFrom(handler func(*types.Receipt, error), sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncTransferFrom(handler, &_ONGX.TransactOpts, sender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0xad8a9731.
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ONGX *ONGXTransactorSession) TransferFrom(sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, *types.Receipt, error) {
	return _ONGX.Contract.TransferFrom(&_ONGX.TransactOpts, sender, recipient, amount)
}

func (_ONGX *ONGXTransactorSession) AsyncTransferFrom(handler func(*types.Receipt, error), sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ONGX.Contract.AsyncTransferFrom(handler, &_ONGX.TransactOpts, sender, recipient, amount)
}
